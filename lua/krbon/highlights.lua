...
function M.setup()
	...
	local highlights = {
		...
		SpellBad = { fg = c.none, fmt = cfg.undercurl and "undercurl" or "underline", sp = c.magenta },
		SpellCap = { fg = c.none, fmt = cfg.undercurl and "undercurl" or "underline", sp = c.lavender },
		SpellLocal = { fg = c.none, fmt = cfg.undercurl and "undercurl" or "underline", sp = c.blue },
		SpellRare = { fg = c.none, fmt = cfg.undercurl and "undercurl" or "underline", sp = c.pink },
		...
		DiagnosticUnderlineError = { fmt = cfg.undercurl and "undercurl" or "underline", sp = c.magenta },
		DiagnosticUnderlineHint = { fmt = cfg.undercurl and "undercurl" or "underline", sp = c.sky },
		DiagnosticUnderlineInfo = { fmt = cfg.undercurl and "undercurl" or "underline", sp = c.fg0 },
		DiagnosticUnderlineWarn = { fmt = cfg.undercurl and "undercurl" or "underline", sp = c.lavender },
